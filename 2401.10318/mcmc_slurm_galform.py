...
def lnpost_global_data_v3(y):
    ...
    Mr, r12, probs = properties_given_theta_v3(
        ...
        total_data['Halo_ML_prob'], y[1], gamma_M, y[6],y[4],y[5],y[7],1.,
...
for i in [2]:
    ...
    for j,d in enumerate(data):
        ...
        alpha, mpeak_cut, B, sigma_M, sigma_r, A, n, sigma_mpeak = -1.436, 7.85, 0.93, 0.2, 0.63, 0.037, 1., 0.2
        count1_all = []
        count2_all = []
    ...
    with open('datavector_cdm_galform{}.pickle'.format(i),
              'wb') as handle:
    ...
    truth=[-1.436, 0.2, 8, 0.93, 0.2, 1000.0*0.037, 0.63, 1.],
    display=True,filename="corner_cdm_galform{}.pdf".format(i))
